...
class SetupCyberFHD(ConfigListScreen, Screen):
	...
	def list(self):
		...
		tab = " "*10
		section = _("Fonts")
		list.append((sep*(char-(len(section))//2) + tab + section + tab + sep*(char-(len(section))//2)))
		list.append((_("Fonts:"), config.skin.cyberfhd.fonts))
		section = _("Style")
		list.append((sep*(char-(len(section))//2) + tab + section + tab + sep*(char-(len(section))//2)))
		list.append((_("Color setting:"), config.skin.cyberfhd.colorsetting))

		list.append((_("Background 1 color:"), config.skin.cyberfhd.colorbackground1))
		list.append((_("Background 2 color:"), config.skin.cyberfhd.colorbackground2))
		list.append((_("Background 3 color:"), config.skin.cyberfhd.colorbackground3))

		list.append((_("Background 2 corner:"), config.skin.cyberfhd.cornerbackground2))
		list.append((_("Background 3 corner:"), config.skin.cyberfhd.cornerbackground3))

		list.append((_("Progress color:"), config.skin.cyberfhd.colorbackground4))
		list.append((_("Cursor color:"), config.skin.cyberfhd.colorbackground5))

		list.append((_("Title text color:"), config.skin.cyberfhd.colorforeground1))
		list.append((_("Main text color:"), config.skin.cyberfhd.colorforeground2))
		list.append((_("Additional text color:"), config.skin.cyberfhd.colorforeground3))
		list.append((_("Indication text color:"), config.skin.cyberfhd.colorforeground4))
		list.append((_("Icon`s color:"), config.skin.cyberfhd.colorforeground5))

		list.append((_("Background transparent:"), config.skin.cyberfhd.backgroundtransparent))
		list.append((_("Text transparent:"), config.skin.cyberfhd.foregroundtransparent))
		section = _("Infobar")
		list.append((sep*(char-(len(section))//2) + tab + section + tab + sep*(char-(len(section))//2)))
		list.append((_("Channel number in infobar:"), config.skin.cyberfhd.numberchannel))
		list.append((_("Tuner panel in infobar:"), config.skin.cyberfhd.tunerpanelinfobar))
		list.append((_("EPG panel in secondinfobar:"), config.skin.cyberfhd.epgpanelinfobar))
		list.append((_("Crypted panel in secondinfobar:"), config.skin.cyberfhd.cryptedpanelinfobar))
		list.append((_("Info panel in secondinfobar:"), config.skin.cyberfhd.infopanelinfobar))
		list.append((_("Show CI in info panel:"), config.skin.cyberfhd.cipanelinfobar))
		list.append((_("Weather panel in secondinfobar:"), config.skin.cyberfhd.weatherpanelinfobar))
		section = _("Movie Infobar")
		list.append((sep*(char-(len(section))//2) + tab + section + tab + sep*(char-(len(section))//2)))
		list.append((_("Poster in movieinfobar:"), config.skin.cyberfhd.covermovieinfobar))
		list.append((_("Info panel in movieinfobar:"), config.skin.cyberfhd.infopanelmovieinfobar))
		list.append((_("Weather panel in movieinfobar:"), config.skin.cyberfhd.weatherpanelmovieinfobar))
		section = _("Menu")
		list.append((sep*(char-(len(section))//2) + tab + section + tab + sep*(char-(len(section))//2)))
		list.append((_("Progress mode:"), config.skin.cyberfhd.progressmode))
		list.append((_("Scrollbar in menu:"), config.skin.cyberfhd.scrollbarmode))
		section = _("Channel Selection")
		list.append((sep*(char-(len(section))//2) + tab + section + tab + sep*(char-(len(section))//2)))
		list.append((_("Userbouquet name in channel selection:"), config.skin.cyberfhd.bouquetchannelselection))
		list.append((_("Picon panel in channel selection:"), config.skin.cyberfhd.piconchannelselection))
		list.append((_("Channel info panel in channel selection:"), config.skin.cyberfhd.channelpanelchannelselection))
		list.append((_("EPG panel in channel selection:"), config.skin.cyberfhd.epgpanelchannelselection))

		section = _("Radio Selection")
		list.append((sep*(char-(len(section))//2) + tab + section + tab + sep*(char-(len(section))//2)))
		list.append((_("Userbouquet name in radio channel selection:"), config.skin.cyberfhd.bouquetradiochannelselection))
		section = _("Movie Selection")
		list.append((sep*(char-(len(section))//2) + tab + section + tab + sep*(char-(len(section))//2)))
		list.append((_("Description panel in movie selection:"), config.skin.cyberfhd.panelmovieselection))
		return list
	...
	def download(self):
	# download plugin
		urlretrieve("https://raw.githubusercontent.com/Vasiliks/CyberFHD/master/python/Plugins/Extensions/SetupCyberFHD/plugin.py","/tmp/plugin.py")
		urlretrieve("https://raw.githubusercontent.com/Vasiliks/CyberFHD/master/python/Plugins/Extensions/SetupCyberFHD/locale/ru/LC_MESSAGES/SetupCyberFHD.mo","/tmp/ruSetupCyberFHD.mo")
		urlretrieve("https://raw.githubusercontent.com/Vasiliks/CyberFHD/master/python/Plugins/Extensions/SetupCyberFHD/locale/de/LC_MESSAGES/SetupCyberFHD.mo","/tmp/deSetupCyberFHD.mo")
	# download skin
		urlretrieve("https://raw.githubusercontent.com/Vasiliks/CyberFHD/master/share/enigma2/CyberFHD/skin.xml","/tmp/skin.xml")
		urlretrieve("https://raw.githubusercontent.com/Vasiliks/CyberFHD/master/share/enigma2/CyberFHD/skin_style.xml","/tmp/skin_style.xml")
		urlretrieve("https://raw.githubusercontent.com/Vasiliks/CyberFHD/master/share/enigma2/CyberFHD/skin_templates.xml","/tmp/skin_templates.xml")
		urlretrieve("https://raw.githubusercontent.com/Vasiliks/CyberFHD/master/share/enigma2/CyberFHD/skin_templates_style.xml","/tmp/skin_templates_style.xml")
		urlretrieve("https://raw.githubusercontent.com/Vasiliks/CyberFHD/master/share/enigma2/CyberFHD/skin_extra.xml","/tmp/skin_extra.xml")
	# download converter
		urlretrieve("https://raw.githubusercontent.com/68foxboris/enigma2-components/master/python/Components/Converter/AlwaysTrue.py","/tmp/AlwaysTrue.py")
		urlretrieve("https://raw.githubusercontent.com/68foxboris/enigma2-components/master/python/Components/Converter/AC3DownMixStatus.py","/tmp/AC3DownMixStatus.py")
		urlretrieve("https://raw.githubusercontent.com/68foxboris/enigma2-components/master/python/Components/Converter/CaidInfo2.py","/tmp/CaidInfo2.py")
		urlretrieve("https://raw.githubusercontent.com/68foxboris/enigma2-components/master/python/Components/Converter/CamdInfo3.py","/tmp/CamdInfo3.py")
		urlretrieve("https://raw.githubusercontent.com/68foxboris/enigma2-components/master/python/Components/Converter/EventName2.py","/tmp/EventName2.py")
		urlretrieve("https://raw.githubusercontent.com/68foxboris/enigma2-components/master/python/Components/Converter/FrontendInfo2.py","/tmp/FrontendInfo2.py")
		urlretrieve("https://raw.githubusercontent.com/68foxboris/enigma2-components/master/python/Components/Converter/ModuleControl.py","/tmp/ModuleControl.py")
		urlretrieve("https://raw.githubusercontent.com/68foxboris/enigma2-components/master/python/Components/Converter/MovieInfo2.py","/tmp/MovieInfo2.py")
		urlretrieve("https://raw.githubusercontent.com/68foxboris/enigma2-components/master/python/Components/Converter/ProgressDiskSpaceInfo.py","/tmp/ProgressDiskSpaceInfo.py")
		urlretrieve("https://raw.githubusercontent.com/68foxboris/enigma2-components/master/python/Components/Converter/ServiceInfoEX.py","/tmp/ServiceInfoEX.py")
		urlretrieve("https://raw.githubusercontent.com/68foxboris/enigma2-components/master/python/Components/Converter/ServiceName2.py","/tmp/ServiceName2.py")
		urlretrieve("https://raw.githubusercontent.com/68foxboris/enigma2-components/master/python/Components/Converter/TunerBar.py","/tmp/TunerBar.py")
	# download renderer
		urlretrieve("https://raw.githubusercontent.com/68foxboris/enigma2-components/master/python/Components/Renderer/AnimatedWeatherPixmap.py","/tmp/AnimatedWeatherPixmap.py")
		urlretrieve("https://raw.githubusercontent.com/68foxboris/enigma2-components/master/python/Components/Renderer/AnimatedMoonPixmap.py","/tmp/AnimatedMoonPixmap.py")
		urlretrieve("https://raw.githubusercontent.com/68foxboris/enigma2-components/master/python/Components/Renderer/MovieCover.py","/tmp/MovieCover.py")
		urlretrieve("https://raw.githubusercontent.com/68foxboris/enigma2-components/master/python/Components/Renderer/MovieRating.py","/tmp/MovieRating.py")
		urlretrieve("https://raw.githubusercontent.com/68foxboris/enigma2-components/master/python/Components/Renderer/PiconUni.py","/tmp/PiconUni.py")
		urlretrieve("https://raw.githubusercontent.com/68foxboris/enigma2-components/master/python/Components/Renderer/RendVolumeTextP.py","/tmp/RendVolumeTextP.py")
		urlretrieve("https://raw.githubusercontent.com/68foxboris/enigma2-components/master/python/Components/Renderer/Watches.py","/tmp/Watches.py")
	# end
		self.install()
